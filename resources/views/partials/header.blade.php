    ...
    <div class="navTop">
        ...
        <div class="navbar-collapse collapse">
            <ul class="navbar-nav navbar-align">
                <li class="mx-4">
                    <span id="theme-btn" class="material-symbols-rounded" data-animation="true" data-toggle="tooltip"
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        {{-- <a class="dropdown-item" href="#">
                            <svg class="icon-xl-heavy" xmlns="http://www.w3.org/2000/svg" fill="none"
                                ...
                                <path stroke-linejoin="round" stroke-linecap="round" stroke-width="2"
                                    stroke="currentColor"
                                    d="M4 22C4 17.5817 7.58172 14 12 14C16.4183 14 20 17.5817 20 22"></path>
                            </svg>
                            Profile
                        </a> --}}
